...
std::tuple<bool, bool, int, int> BATTLESHIP::StepReal(STATE& state, int action, int& observation, double& reward)
{
    return make_tuple(false, false, -1, -1);
}

void BATTLESHIP::UpdateProbabiliticMap(int x, int y, int action, bool isCollision)
{

}

void BATTLESHIP::ClearMap()
{

}

std::tuple<bool, std::vector<int>> BATTLESHIP::Rollout(STATE& state)
{
