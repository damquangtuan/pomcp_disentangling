...
public:
    ...
    virtual std::tuple<bool, bool, int, int> StepReal(STATE& state, int action,
                                                    int& observation, double& reward) = 0;
    virtual void UpdateProbabiliticMap(int x, int y, int action, bool isCollision) = 0;
    virtual void ClearMap() = 0;

    //to Calculate Rollout
    virtual std::tuple<bool, std::vector<int>> Rollout(STATE& state) = 0;
